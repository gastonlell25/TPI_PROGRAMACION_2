...
Asegurate de tener un servidor MySQL 8.x en ejecución.

Crear la base de datos y usuario (si corresponde).
Por ejemplo:
...
Abrir el proyecto en tu IDE (IntelliJ, NetBeans, Eclipse).

Esperar a que se resuelvan las dependencias.

Compilar el proyecto desde el menú Build.
...
Configurá la clase de arranque (por ejemplo Main.Main).

Ejecutá el proyecto desde el botón de Run.
